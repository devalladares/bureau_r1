...
const DNA_PARAMS = {
  ...
  cycles: MOBILE ? 1 : 0.75, // Changed for mobile
  waveOffset: 0,
  waveAmplitude: 300,
  animationSpeed: 0.15,
  waveSpeed: 0.03,
...
const PARAMS = {
  ...
  maxSpeed: MOBILE ? 6 : 4, // Increased speed on mobile
  maxForce: 0.2,
  ...
  loadingDistance: MOBILE ? 25 : 15, // Increased distance on mobile
...
function initializeGridParticles() {
  ...
  // Example: If on mobile, let’s define 4 columns
